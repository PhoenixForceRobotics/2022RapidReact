...
public class down90 extends CommandBase {
	private OI oi;
	private PID pid;
	...
	//add requirments for down 90

	public down90(Intakesystem drivebase, PID pid)
	{
	...
	//Begin down 90 command; set pid point, set tolorance, reset encoder and pid
	...
	//Exicute down 90 (this will loop until command is over)
	@Override
	public void execute()
	{

...
public class BobXboxController extends Joystick {
  ...
  public BobAxisButton leftTriggerButton =
      new BobAxisButton(this, XboxAxis.LEFT_TRIGGER, .25, ThresholdType.GREATER_THAN);
  public BobAxisButton rightTriggerButton =
      new BobAxisButton(this, XboxAxis.RIGHT_TRIGGER, .25, ThresholdType.GREATER_THAN);
